...
public class EventController {
    ...
    @GetMapping("edit/{id}")
    public String displayEditEventForm(@PathVariable int id, Model model){
    ...
    @PostMapping("edit/{id}")
    public String processEditEventForm(@PathVariable int id, @ModelAttribute Event newEvent){
